  ...
  public class LoginPage
    {
        ...
        public static void LoginStep()
        {
           ...
           Driver.NavigateUrl();
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@name='email']")).SendKeys("mvpstudio.qa@gmail.com");
            //Enter password
            Driver.driver.FindElement(By.XPath("//input[contains(@name,'password')]")).SendKeys("SydneyQa2018");
            Thread.Sleep(1000);
           ...
           Assert.AreEqual(loggedin.Text,"Hi Testing");
        }
